...
const Cards = () => {
  return (
    <div className=" flex w-full  flex-wrap justify-center  lg:justify-between gap-4 md:justify-center overflow-y-hidden ">
      {fetchData.map((item) =>
        item.properties.map((data,id) => (
          <div className="h-[430px] w-[380px]  bg-gray-200 rounded-xl" key={id}>
            <div className="">
              <img
            ...
            <div className="flex flex-col justify-between h-1/2">
              <div className="flex justify-between items-center px-2">
                <div>
                  <p className="text-[#7067E7] font-semibold">₹{data.list_price}/month</p>
                </div>
              ...
              <div className="px-2">
                ...
                <p>
                  {data.location.address.line}, <span className="font-semibold">{data.location.address.city}, California</span> 
                </p>
              </div>
             
              <div className="flex p-2 gap-2 flex-col">
                 <div className="border-b-2 border-gray-400"/>
                 <div className="flex flex-row justify-around" >  <p>{data.description.beds} BHK</p>
                <p> {data.description.baths} Bathrooms </p>
                <p> {data.description.sqft} sqft </p></div>
